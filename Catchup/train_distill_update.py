...
#generate zs
'''
python train_distill_update.py  --N 16 --gpu 0,1 --dir ./runs/distll-onlineslim-predstep-1-uniform-shakedrop0.75-beta20/ \
--latent_dir ./runs/proper_cifar10-onlineslim-predstep-1-uniform-shakedrop0.75-beta20/test_16/zs/ --traj_dir ./runs/proper_cifar10-onlineslim-predstep-1-uniform-shakedrop0.75-beta20/test_16/ \
--learning_rate 3e-4 --optimizer adam --batchsize 16 --iterations 20000 --flow_ckpt ./runs/proper_cifar10-onlineslim-predstep-1-uniform-shakedrop0.75-beta20/flow_model_250000_ema.pth \
--config_en configs/cifar10_en.json --config_de configs/cifar10_de.json --pred_step 1
'''
import torch
import numpy as np
