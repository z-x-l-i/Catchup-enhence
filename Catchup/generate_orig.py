...
'''python generate_ori.py --gpu 0 --dir ./runs/proper_cifar10-onlineslim-predstep-1-uniform-shakedrop0.75-beta20/test_16 --N 16 \
--res 32 --input_nc 3 --num_samples 500 --ckpt runs/pt_test_1_cifar10-onlineslim-predstep-1-uniform-shakedrop0.75-beta20/flow_model_40500_ema.pth \
...
python generate_orig.py --gpu 0 --dir ./runs/proper_cifar10-onlineslim-predstep-1-uniform-shakedrop0.75-beta20/test_16 --N 16 --res 32\
 --input_nc 3 --num_samples 50000 --ckpt ./runs/proper_cifar10-onlineslim-predstep-1-uniform-shakedrop0.75-beta20/flow_model_150000_ema.pth\
  --config_en configs/cifar10_en.json --config_de configs/cifar10_de.json --dataset celebahq --solver euler --shakedrop --phi 0.75 --save_sub_traj --save_z
        ...
        for ep in tqdm(range(epoch)):
            ...
            for idx in range(len(x0)):
                ...
                if arg.save_data:
                    ...
                    save_image(z[idx] * 0.5 + 0.5 if not arg.no_scale else z[idx], os.path.join(arg.dir, "noisy_data", f"{i:05d}.png"))
                if arg.save_sub_traj and arg.solver in ['euler', 'heun']:
                    for mm,trag_sub_x0 in enumerate(traj_uncond_x0):
                        ...
                        torch.save(trag_sub_x0[idx]* 0.5 + 0.5 if not arg.no_scale else trag_sub_x0[idx], os.path.join(arg.dir, f"trajs_{mm}", f"{i:05d}.pt"))
                i+=1
